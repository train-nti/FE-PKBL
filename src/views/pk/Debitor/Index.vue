    ...
    <div class="animated fadeIn">
        <div class="card">
            <div class="card-body">
                ...
                <b-row>
                    <b-col md="4"><b-button @click="showModal" variant="primary">Tambah Customer</b-button></b-col>
                    <b-col md="4" offset-md="4">
                        <div class="input-group">
                            <input placeholder="Cari" icon="search" v-model="filter">
                    ...
                    <b-tabs class="full-widths" v-model="tabIndex[0]">
                        ...
                        <b-tab active>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <date-picker v-model="customers.DateofBirth" :input-attr="{ required: true }" valueType="YYYY-MM-DD" format="DD/MMM/YYYY" lang="id"></date-picker>
                     ...
                     <template v-slot:row-details="data" >
                        <b-card>
                            ...
                            <b-row class="mb-4">
                                ...
                                <b-col>{{ data.item.DateofBirth | formatDate}}</b-col>
                            </b-row>

                            <b-row class="mb-4">
                                <b-col sm="3" class="text-sm-right"><b>Jenis Kelamin:</b></b-col>
                                <b-col v-if="data.item.Gender === true">Laki-Laki</b-col>
                            ...
                            <b-row class="mb-4">
                                ...
                                <b-col>{{ data.item.MaritalStatus }}</b-col>
                            </b-row>

                            <b-row class="mb-4">

                                <b-col sm="3" class="text-sm-right" v-if="data.item.Gender === true"><b>Nama Istri:</b></b-col>
                                <b-col v-if="data.item.Gender === true">{{ data.item.SpouseName }}</b-col>
                                <b-col sm="3" class="text-sm-right" v-if="data.item.Gender === false"><b>Nama Suami:</b></b-col>
                                <b-col v-if="data.item.Gender === false">{{ data.item.SpouseName }}</b-col>
                            ...
                            <b-row class="mb-4">
                                ...
                                <b-col>{{ data.item.MotherName }}</b-col>
                            </b-row>
                        </b-card>
                      </template>
                  </b-table>
...
<script>
    ...
    export default {
        ...
        methods: {
          onFiltered(filteredItems) {
            ...
            async getAll() {
                ...
                try {
                    var debitorData = await apiDebitor.getAllByWACode(this.cabang)
        ...
        computed: {
          ...
          rows_debitor() {
            return this.CustomersItems.length
          },
        },
        mounted() {
          // Set the initial number of items
          this.rows_debitor= this.CustomersItems.length
        },
    }
</script>
