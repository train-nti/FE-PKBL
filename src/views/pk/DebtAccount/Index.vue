                      ...
                      <table class="table table-striped table-bordered table-hover">
                          ...
                          <thead>
                              <tr>
                                <!-- <th @click="sort('DebCode')" class="text-center">Nomor Mitra Binaan</th> -->
                                <th @click="sort('FullName')" class="text-center">Nama Lengkap</th>
                                <th @click="sort('IDNumber')" class="text-center">Nilai Pinjaman</th>
                                <th @click="sort('PlaceofBirth')" class="text-center">Tenor</th>
                                <th @click="sort('PlaceofBirth')" class="text-center">Status</th>
                                  <th class="text-center">Aksi</th>
                              </tr>
                          </thead>
                          ...
                          <tbody>
                              <template v-for="(data, index) in filterDataBelumCair" v-bind:value="index">
                                  <tr>
                                    <!-- <td>{{ data.DACode }}</td> -->
                                    <td>{{ data.FullName }}</td>
                                    <td>{{ formatCurrency(data.DebValue) }}</td>
                                    <td>{{ data.Tenor }}</td>
                                    <td>Belum Lunas</td>
                                      <td class="text-center">
                                          <!-- <button type="button" class="btn btn-primary" @click="">
                                            ...
                                            <button type="button" v-b-modal.modal-multi-2 class="btn btn-success" @click="editBelumCair(data)">
                                              <i class="fa fa-pencil "></i>
                                          </button>
                                          <!-- <button type="button" class="btn btn-danger" @click="">
                                              <i class="fa fa-trash"></i>
    ...
    export default {
        ...
        methods: {
          ...
          async save() {
            ...
            var dataFlat = this.calculate(this.debitAccountItems.Tenor, this.debitAccountItems.DebValue, this.debitAccountItems.InterestRate,this.debitAccountItems.DACode)
          ...
          calculate(tenor, nilai, sukuBunga, DACode) {
              ...
              for (var i = 1; i <= tenor; i++) {
                  getDateNow = moment().add(i, 'M').format('DD MMMM YYYY')
