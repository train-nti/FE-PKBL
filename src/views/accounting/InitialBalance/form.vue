          ...
          <b-row>
            <!-- <b-col sm="2" offset-sm="11">
              <div class="form-group form-actions">
                  <b-button size="md" @click="showModal()" variant="primary">Add</b-button>
              </div>
            </b-col> -->
            <b-col sm="12">
                <c-table :table-data="items" :fields="fields" caption="" custom="newSlot" routeName="Form Document Desaigner" >
                  <template slot-scope="{ action }">
                    <router-link :to="{ name: 'Detailed Balance', params: {AccountId: action.AccumulatedAcc} }">
  ...
  data () {
    return {
      ...
      fields: [
        ...
        {key: 'Posisi'},
        // {key: 'Description'},
        {label: 'Saldo',key: 'AccumulatedAcc'},
        {key:'aksi'}
      ],
