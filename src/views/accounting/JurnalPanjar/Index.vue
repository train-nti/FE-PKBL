...
<div class="animated fadeIn">
  ...
  <b-row v-if="!loading">
    <b-col sm="12">
      <b-card>
        <div slot="header">
          <strong>Jurnal Pertanggungjawaban</strong>
        </div>
        <form @submit.prevent="SaveJournal">
         ...
         <!--    <b-row>
            ...
            <b-row >
                ...
                <b-col md="1" class="my-1" v-if="(id != null)&&(status == 'edit')">
