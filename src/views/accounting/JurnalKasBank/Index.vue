            ...
            :filter="filter"
             @filtered="onFiltered">
              <template slot="action" slot-scope="data">
                 ...
                 <router-link :to="{ name: 'Jurnal Kas Bank Form', params: { status : 'detail', id: data.item.Jrn_ID } }">
                 ...
                 <router-link :to="{ name: 'Jurnal Kas Bank Form', params: { status : 'edit', id: data.item.Jrn_ID } }">
...
export default {
  ...
  methods: {
    ...
    async showModalKoreksi(data){
      console.log(data.JournalTypeId);
