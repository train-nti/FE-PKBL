...
<div class="animated fadeIn">
  <b-row>
    <b-col sm="12">
      ...
      <b-card>
        <div slot="header">
          <strong>Jurnal Kas Bank-PK</strong>
        </div>
        <form @submit.prevent="SaveJournal">
          ...
          <b-row >
              <b-col md="1" class="my-1" v-if="id != null">
                <router-link :to="{ name: 'Jurnal Kas Bank-PK', params: {} }"><b-col><b-button type="submit" variant="danger">Kembali</b-button></b-col></router-link>
              </b-col>
  ...
  watch:{
   'JournalItemModel.IsDebet': async function () {
     ...
     if(this.JournalItemModel.IsDebet){
       var getall = await apiAccount.getByType(6)
       ...
       var getall1 = await apiAccount.getByType(6)
      ...
      if (isUpdate) {
        ...
        // await apiJournalItem.update(this.$route.params.id, this.items);
          ...
          if (this.items.length > 0) {
            ...
            this.JournalModel.JournalTypeId = 6
            ...
            this.$router.push('/accounting/jurnal-kas-bank-pk')
