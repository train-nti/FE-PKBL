        ...
        <b-row>
          <b-col sm="2" offset-sm="11">
            <div class="form-group form-actions">
              <router-link :to="{ name: 'Jurnal Penyaluran BL Form' }">
            ...
            :filter="filter"
             @filtered="onFiltered">
              <template slot="action" slot-scope="data">
                 ...
                 <router-link :to="{ name: 'Jurnal Penyaluran BL Form', params: { id: data.item.Jrn_ID } }">
...
export default {
  ...
  methods: {
    async getAll(dari = null, hingga = null) {
      ...
      try {
        var dataTable = await apiJournal.getAllByType(7,this.cabang,dari,hingga)
