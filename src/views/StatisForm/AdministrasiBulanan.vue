...
<div class="">
  <div class="card">
    <div class="card-body">
    	 <b-button class="mt-3" variant="primary" block @click="showModal">Closing Bulanan</b-button>
	...
	async mounted() {
	  ...
	  methods: {
		 ...
		 async simpanData(){
		  	...
		  	var ubahConfiq = await apiConfiq.update("POSTING_MONTHLY",this.Confiq)
		 ...
		 async showConfiq(){
		  	var dataConfiq = await apiConfiq.getByCode("POSTING_MONTHLY")
