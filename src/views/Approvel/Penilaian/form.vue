                        ...
                        <b-col sm="12">
                            <b-tabs class="full-widths" v-model="tabIndex[0]">
                               ...
                               <b-tab v-if="username == 'Staff Pusat'">
                                  ...
                                  <b-row>
                                    <b-col sm="12">
                                      <b-table id="tambah_penilaian" :fields="fields" caption=""  :per-page="perPage_tambah_penilaian" :current-page="currentPage_tambah_penilaian" :items="items_penilaian">
                              ...
                              <b-tab v-if="username == 'Staff Pusat'">
                                  ...
                                  <b-row>
                                    <b-col sm="12">
                                      <b-table id="tambah_penilaianPK" :fields="fields" caption=""  :per-page="perPage_tambah_penilaianPK" :current-page="currentPage_tambah_penilaianPK" :items="items_penilaianPK">
                                        <template slot="aksi" slot-scope="data">
