  ...
  <div class="animated fadeIn">
    <b-row>
      <b-col sm="12">
        <b-card>
          <div slot="header">
            <strong>Bussiness Process</strong>
          </div>
          <b-row>
            <b-col sm="2" offset-sm="11">
              <div class="form-group form-actions">
                <router-link :to="{ name: 'Form Bussiness Process' }">
                  <b-button size="md" variant="primary">Tambah</b-button>
                </router-link>
              </div>
            </b-col>
            <b-col sm="12">
                <c-table :table-data="items" :fields="fields" caption="" routeName="Form Bussiness Process" :clickHandler="deleteDocument"></c-table>
            </b-col>
          </b-row>
        </b-card>
      </b-col>
